...
namespace TamkeenRegistration.TaskManagement
{
    public partial class TaskMAnagement : System.Web.UI.Page
    {
        ...
        protected void  btnMyWI_Click(object sender, EventArgs e)
        {
            Response.Write("<script>");
            Response.Write("window.open('MyWIs.aspx?" + "&target=_blank')");
            Response.Write("</script>");
        }

        protected void btnSelfCheck_Click(object sender, EventArgs e)
        {
            Response.Write("<script>");
            Response.Write("window.open('MySelfCheck.aspx?" + "&target=_blank')");
            Response.Write("</script>");
        }

        protected void btnLeaderCheck_Click(object sender, EventArgs e)
        {
            Response.Write("<script>");
            Response.Write("window.open('LeaderCheck.aspx?" + "&target=_blank')");
            Response.Write("</script>");
        }
        ...
        private void LoadWIs(char Gender, int TaskId)
        {
            if (sqlCon.State == ConnectionState.Closed)
                sqlCon.Open();
            SqlDataAdapter sqlDa = new SqlDataAdapter("WiViewByTaskID", sqlCon);
            sqlDa.SelectCommand.CommandType = CommandType.StoredProcedure;
