<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TaskManagement.aspx.cs" Inherits="TamkeenRegistration.TaskManagement.TaskMAnagement" %>
...
<body>
    <form id="TaskManagement" runat="server">
    <div>
            <table>
                <tr>
                    <td>
                        <asp:Button ID="btnMyWis" runat="server" Text="View My WIs" OnClick="btnMyWI_Click" />
                    </td>
                    <td>
                        <asp:Button ID="btnMyEval" runat="server" Text="Admin Self Check" OnClick="btnSelfCheck_Click" />
                    </td>
                    <td>
                        <asp:Button ID="Button2" runat="server" Text="Division Leader Check" OnClick="btnLeaderCheck_Click" />
                    </td>
                </tr>
            </table>
            <br />
